...
This example demonstrates how to use lit-shell to connect to Docker containers directly from the browser.
...
When a client requests a Docker session, lit-shell spawns `docker exec -it <container> <shell>` behind the scenes, giving you a full PTY session inside the container.
...
- Consider running lit-shell in the same Docker network as your containers
