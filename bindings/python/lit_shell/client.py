"""
lit-shell Terminal Client for Python.

Async WebSocket client for connecting to lit-shell terminal servers.
"""
...
class TerminalClient:
    """
    Async WebSocket client for lit-shell terminal servers.
