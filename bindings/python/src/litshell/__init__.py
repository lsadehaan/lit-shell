"""X-Shell Python Client - WebSocket terminal client for lit-shell.js server.

This package provides a Python client for connecting to lit-shell terminal servers.
